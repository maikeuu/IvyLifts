...
extension UIView {
    ...
    public func pinTopToMargins(container: UIView, constant: CGFloat = 0) {
        self.pinTopAnchor(to: container.layoutMarginsGuide.topAnchor, constant: constant)
    }
    
    /// Pin bottom of view to the layout margins of some container
    public func pinBottomToMargins(container: UIView, constant: CGFloat = 0) {
        self.pinBottomAnchor(to: container.layoutMarginsGuide.bottomAnchor, constant: constant)
    }
...
extension UIView {
    ...
    public func pinHorizontalSides(left: NSLayoutXAxisAnchor, leftPadding: CGFloat = 0, right: NSLayoutXAxisAnchor, rightPadding: CGFloat = 0) {
        self.pinLeftAnchor(to: left, constant: leftPadding)
        self.pinRightAnchor(to: right, constant: rightPadding)
    }
    ...
    public func pinVerticalSides(top: NSLayoutYAxisAnchor, topPadding: CGFloat = 0, bottom: NSLayoutYAxisAnchor, bottomPadding: CGFloat = 0) {
        self.pinTopAnchor(to: top, constant: topPadding)
        self.pinBottomAnchor(to: bottom, constant: bottomPadding)
    }
}
...
extension UIView {
    ...
    public func pinLeftAnchor(to view: NSLayoutXAxisAnchor, constant: CGFloat = 0) {
        self.translatesAutoresizingMaskIntoConstraints = false
        self.leftAnchor.constraint(equalTo: view, constant: constant).isActive = true
    }
    
    /// Set the right anchor of a view. Converts constant to use positive values for padding respective to right side
    public func pinRightAnchor(to view: NSLayoutXAxisAnchor, constant: CGFloat = 0) {
        self.translatesAutoresizingMaskIntoConstraints = false
        self.rightAnchor.constraint(equalTo: view, constant: -constant).isActive = true
    }
    
    /// Set the top anchor of a view
    public func pinTopAnchor(to view: NSLayoutYAxisAnchor, constant: CGFloat = 0) {
        self.translatesAutoresizingMaskIntoConstraints = false
        self.topAnchor.constraint(equalTo: view, constant: constant).isActive = true
    }
    
    /// Set the bottom anchor of a view. Converts constant to use positive values for padding respective to the bottom side
    public func pinBottomAnchor(to view: NSLayoutYAxisAnchor, constant: CGFloat = 0) {
        self.translatesAutoresizingMaskIntoConstraints = false
        self.bottomAnchor.constraint(equalTo: view, constant: -constant).isActive = true
    }
}
